...
int function_definition()
{
    ...
    TokenN TK_SAVE = token.current_token;
    if (declaration_specifiers())
    {
        if (declarator())
        {
            long posiFILE2 = getPosi();
            TokenN TK_SAVE2 = token.current_token;
            if (declaration_list())
            {
            ...
            restartPosi(posiFILE2, TK_SAVE2);
            if (compound_statement())
                return 1;
            return 0;
        }
...
int type_specifier()
{
    ...
    if (token.current_token == TK_INT)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_LONG)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_FLOAT)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_CHAR)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_DOUBLE)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_UNSIGNED)
    {
        getNextToken();
        return 1;
    }
...
int logical_or_expression_line()
{
    printf("logical_or_expression_line\n");
...
int logical_and_expression_line()
{
    printf("logical_and_expression_line\n");
...
int inclusive_or_expression_line()
{
    printf("inclusive_or_expression_line\n");
...
int exclusive_or_expression_line()
{
    printf("exclusive_or_expression_line\n");
...
int equality_expression_line()
{
    printf("equality_expression_line\n");
...
int relational_expression_line()
{
    printf("relational_expression_line\n");
...
int additive_expression_line()
{
    printf("additive_expression_line\n");
...
int multiplicative_expression_line()
{
    printf("multiplicative_expression_line\n");
    if (token.current_token == TK_MULTIPLY)
    {
        getNextToken();
        if (unary_expression())
...
int unary_operator()
{
    ...
    if (token.current_token == TK_TILDE)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_BITWISE_NOT)
    {
        getNextToken();
        return 1;
    }
...
int postfix_expression_line()
{
    printf("postfix_expression_line\n");
    if (token.current_token == TK_LBRACKET)
    {
        getNextToken();
        if (expression())
...
int assignment_operator()
{
    ...
    if (token.current_token == TK_MULTIPLY_EQUAL)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_DIVIDE_EQUAL)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_MODULO_EQUAL)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_PLUS_EQUAL)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_MINUS_EQUAL)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_LESS_LESS_EQUAL)
    {
        getNextToken();
        return 1;
    }
    if (token.current_token == TK_GREATER_GREATER_EQUAL)
    {
        getNextToken();
        return 1;
    }
...
int init_declarator_list_line()
{
    printf("init_declarator_list_line\n");
    if (token.current_token == TK_COMMA)
    {
        getNextToken();
        if (init_declarator())
...
int declaration_or_statement_list()
{
    printf("declaration_or_statement_list\n");
    long posiFILE = getPosi();
    TokenN TK_SAVE = token.current_token;
    if (declaration_list())
    {
        if (declaration_or_statement_list_line())
            return 1;
        return 0;
    }
    restartPosi(posiFILE, TK_SAVE);
...
int declaration_or_statement_list_line()
{
    printf("declaration_or_statement_list_line\n");
    long posiFILE = getPosi();
    TokenN TK_SAVE = token.current_token;
    if (declaration_list())
    {
...
int argument_expression_list_line()
{
    printf("argument_expression_list_line\n");
    if (token.current_token == TK_COMMA)
    {
        getNextToken();
        if (assignment_expression())
